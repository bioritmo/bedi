...
module Bedi
  RSpec.describe Redecard do
    describe '#parse' do
      context '"transação de crédito" return (TORC)' do
      ...
      context '"cancelamento eletrônico" return (TOCA)' do
        let(:file) { fixture_file('redecard_cancelamento_eletronico') }
        ...
        it 'parses the header fields' do
          ...
          expect(header).to include(
            ...
            hora_de_gravacao: '223344',
            produto: '3',
            numero_de_sequencia_no_lote: ' ' * 3,
            numero_do_lote: ' ' * 5,
            data_do_protocolo: ' ' * 6,
            data_para_o_credito: ' ' * 6,
            status_do_movimento: 'R',
            numero_de_sequencia_do_registro: '00001',
          )
        end
        ...
        it 'parses the type 01 entry fields' do
          ...
          expect(entries01).to include(
            ...
            numero_da_maquineta: '123456789',
            numero_da_autorizacao: '666666',
            numero_do_comprovante_de_venda: '123456789012',
            valor_da_venda: '0' * 15,
            valor_a_restituir: '0' * 15,
            valor_total: '0' * 15,
            data_da_venda: '170831',
            numero_de_parcelas: '  ',
            ...
            numero_do_lote: '     ',
            codigo_do_retorno: '99',
            reservado: '1234567890123456789012345',
            numero_de_sequencia_do_registro: '00002'
          )
        end
        ...
        it 'parses the type 30 entry fields' do
          ...
          expect(entries30).to include(
            ...
            numero_da_maquineta: '123456789',
            data_do_resumo_de_vendas: '170831',
            valor_total_de_cancelamento: '0' * 15,
            total_a_restituir: '0' * 15,
            liquido: '0' * 15,
            parcelas_no_lote: '00000',
            sequencia_do_registro_no_lote: '000',
            numero_do_lote: '00000',
            numero_de_sequencia_do_registro: '00003'
          )
        end
        ...
        it 'parses the type 40 entry fields' do
          ...
          expect(entries40).to include(
            ...
            codigo_da_transacao: '101',
            numero_da_centralizadora_de_pagamento: '123456789',
            valor_total_de_vendas: '0' * 15,
            total_a_restituir: '0' * 15,
            total_liquido: '0' * 15,
            sequencia_do_registro_no_lote: ' ' * 3,
            numero_do_lote: ' ' * 5,
            numero_de_sequencia_do_registro: '00005',
          )
        end
        ...
        it 'parses the trailer fields' do
          ...
          expect(trailer).to include(
            ...
            sequencia_do_registro_no_lote: '000',
            numero_do_lote: '99999',
            sequencia_do_registro_no_movimento: '00006',
          )
        end
      end

      context 'mixed files (both TORC AND TOCA)' do
        let(:file) { fixture_file('redecard_mixed_torc_toca') }

        it 'does not raise errors' do
          expect { subject.parse(file) }.not_to raise_error
        end
      end
    end
  end
